            ...
            <section class="col-lg-6 connectedSortable">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-header">
                        ...
                        <h3 class="box-title"><strong>Sửa nghề nghiệp</strong></h3>
                        <!-- tools box -->
                    ...
                    <form method="post">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    @endif
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{$nn->career_name}}" class="form-control">
                                            @if($errors->has('name'))
                                        ...
                                        <div class="form-group">
                                          ...
                                          <textarea class="form-control" name="describe" rows="5">{{$nn->career_describe}}</textarea>
                        ...
                        <div class="box-footer clearfix">
                            <a class="pull-right btn btn-default" id="sendEmail" href="{{asset('admin/danhmuckhac/nghenghiep')}}">Back <i class="fa fa-arrow-circle-left"></i></a>
